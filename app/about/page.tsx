...
export default function AboutPage() {
  return (
    <div className="material">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4">
        {VALUES.map((v) => (
          <div key={v.title} className="p-8 text-center cell material-inset hover:material transition-all">
            <div className="w-11 h-11 mx-auto rounded-xl material flex items-center justify-center mb-4 shadow-sm">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4">
        {TEAM.map((m) => (
          <div key={m.name} className="p-8 text-center cell material hover:material-elevated transition-all">
            <div className="w-12 h-12 mx-auto rounded-full material-inset flex items-center justify-center text-xs font-bold text-gray-600 mb-4 shadow-inner">
              {m.initials}
            </div>
      ...
      {/* CTA */}
      <Link href="/careers" className="flex items-center justify-center gap-2 p-8 cell material-inset hover:material text-sm font-bold text-gray-900 transition-all uppercase tracking-wider">
