      ...
      {JOBS.map((job) => (
        <div key={job.title} className="grid grid-cols-12 cell material hover:material-elevated transition-all">
          ...
          <div className="col-span-4 flex items-center justify-end p-6">
            <Link href="/contact" className="flex items-center gap-1.5 px-4 py-2 material-dark text-white text-[10px] font-bold rounded-lg hover:opacity-90 transition-all shadow-lg">
